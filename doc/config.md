...
| Key | 名称 | 硬件类型 | sortOrder |
|---|---|---|---|
| `motor_0` | [1] 轴1 (大臂 J1) | 运动控制卡 | 0 |
| `servo_1` | [2] 轴2 (小臂 J2) | 串口总线舵机 | 1 |
| `motor_1` | [3] 轴3 (Z轴) | 运动控制卡 | 2 |
| `servo_2` | [4] 轴4 (翻转 R) | 串口总线舵机 | 3 |
| `motor_2` | [5] 轴5 (夹爪) | 运动控制卡 | 4 |
| `motor_3` | [6] 轴6 (挤出) | 运动控制卡 | 5 |
