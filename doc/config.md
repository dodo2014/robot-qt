...
│   ├── l2       216.0             L2 (小臂长度 mm)
│   ├── z0       45.0              Z0 基准高度 (mm), 轴1不锈钢法兰的上表面
│   └── h1       0.0              大臂垂直高度落差 (mm，向下倾斜固定值；腕点真实高度 = Z电机高度 + z0 − h1) , 测算方法：轴1不锈钢法兰的上表面距离地面470mm(目前机器人放置在地面上)， 夹爪垂直朝下，夹爪的长度130mm, 夹爪末端距离地面165mm, 470 - 130 - 165 = 175;
